...
export default function DeleteProjectModal() {
    ...
    //Realizamos la mutación para poder eliminar el proyecto
    const checkUserPasswordMutation = useMutation({
        mutationFn: checkPassword,
        onError: (error) => toast.error(error.message)
    })

    //Eliminamos el proyecto con el uso del useMutation
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                ...
                                <p className="text-xl font-bold">Confirma la eliminación del proyecto {''}
                                    <span className="text-yellow-500">colocando tu contraseña</span>
                                </p>
